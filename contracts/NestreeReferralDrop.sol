...
contract NestreeReferralDrop
{
    ...
    function drop(address _tokenAddress, address _inviter, uint256 _inviterAmount, address _participant, uint256 _participantAmount) external returns (bool)
    {
